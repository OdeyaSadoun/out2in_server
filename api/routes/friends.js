...
router.post("/calcSocialIndexStudents", auth, authRole("teacher"), friendCtrl.calcSocialIndexStudentsByQuestionnaire); //to do check that this teacher connect to this class
